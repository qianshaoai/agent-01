...
export const LLM_PRESETS: ProviderPreset[] = [
  {
    ...
    label: "OpenAI 官方（GPT-5.5 / GPT-5.4 / GPT-4o）",
    platform: "openai",
    category: "model",
    endpoint: "https://api.openai.com/v1/chat/completions",
    defaultModel: "gpt-4o-mini",
    hint: "default 用 gpt-4o-mini（最便宜的现役兼容模型，仅 API 管理「测试」连通性用，省成本）；正式智能体在搭建器侧选 gpt-5.5 / gpt-5.4 系列等最新模型。需付费 OpenAI 账号；国内访问需经第三方中转 / VPN。",
    recommendedModels: [
      { value: "gpt-5.5",        label: "gpt-5.5（2026/04 旗舰）" },
      { value: "gpt-5.4-pro",    label: "gpt-5.4-pro（深度推理）" },
      { value: "gpt-5.4",        label: "gpt-5.4" },
      { value: "gpt-5.4-mini",   label: "gpt-5.4-mini" },
      { value: "gpt-5.4-nano",   label: "gpt-5.4-nano（最便宜的现役 5.x）" },
      { value: "gpt-5",          label: "gpt-5" },
      { value: "gpt-4o",         label: "gpt-4o" },
      { value: "gpt-4o-mini",    label: "gpt-4o-mini（default · 兼容）" },
    ],
  },
  {
  ...
  {
    code: "zhipu-glm",
    label: "智谱 GLM（glm-4-flash / glm-4-plus / glm-5.1）",
    platform: "zhipu",
    category: "model",
    endpoint: "https://open.bigmodel.cn/api/paas/v4/chat/completions",
    defaultModel: "glm-4-flash",
    hint: "default 用 glm-4-flash（智谱免费模型，仅 API 管理「测试」连通性用）；正式智能体在搭建器选 glm-5.1 / glm-4.6 / glm-4-plus 等付费模型。知识库智能体按 5.20up 验收口径起步 glm-4-air。⚠ 之前预设过 glm-5 已移除（bigmodel.cn 官方文档没找到此 model ID，5.28up 修正）。",
    recommendedModels: [
      { value: "glm-5.1",     label: "glm-5.1（长任务旗舰）" },
      { value: "glm-4.6",     label: "glm-4.6（200K 上下文）" },
      { value: "glm-4.5",     label: "glm-4.5" },
      { value: "glm-4-plus",  label: "glm-4-plus" },
      { value: "glm-4-air",   label: "glm-4-air（5.20up 知识库锁定）" },
      { value: "glm-4-flash", label: "glm-4-flash（default · 免费）" },
    ],
  },
  {
    code: "qwen-dashscope",
    label: "通义千问 / DashScope（qwen-flash / qwen3.6-plus / qwen3.7-max）",
    platform: "openai",
    category: "model",
    endpoint: "https://dashscope.aliyuncs.com/compatible-mode/v1/chat/completions",
    defaultModel: "qwen-flash",
    hint: "default 用 qwen-flash（百炼最便宜系列，仅 API 管理「测试」连通性用）；正式智能体在搭建器选 qwen3.7-max / qwen3.6-plus 等付费模型。阿里云百炼，endpoint 路径含 compatible-mode 走 OpenAI 兼容协议。",
    recommendedModels: [
      { value: "qwen3.7-max",  label: "qwen3.7-max（2026/05 旗舰）" },
      { value: "qwen3.6-plus", label: "qwen3.6-plus（2026/04 · 1M 上下文）" },
      { value: "qwen3.6-flash",label: "qwen3.6-flash（2026/04 便宜）" },
      { value: "qwen-max",     label: "qwen-max" },
      { value: "qwen-plus",    label: "qwen-plus" },
      { value: "qwen-flash",   label: "qwen-flash（default · 最便宜）" },
